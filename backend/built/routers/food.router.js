    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, food_model_1.FoodModel.create(data_1.sample_food)];
            case 2:
                _a.sent();
...
//Get by tag
router.get('/tag/:tag', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var tagterm, foods;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tagterm = req.params.tag;
                return [4 /*yield*/, food_model_1.FoodModel.find({ tags: tagterm })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.get('/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, food_model_1.FoodModel.findById(id)];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
