...
var auth_mid_1 = __importDefault(require("../middlewares.ts/auth.mid"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order_1.OrderModel.deleteOne({
                        user: req.user.id,
                        status: order_status_1.OrderStatus.NEW
                    })];
            case 1:
                _a.sent();
                newOrder = new order_1.OrderModel(__assign(__assign({}, requestOrder), { user: req.user.id }));
...
router.get('/track/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, order_1.OrderModel.findById(req.params.id)];
            case 1:
                order = _a.sent();
                res.send(order);
                return [2 /*return*/];
...
function getNewOrderForCurrentUser(req) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, order_1.OrderModel.findOne({ user: req.user.id, status: order_status_1.OrderStatus.NEW })];
